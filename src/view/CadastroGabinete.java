...
public class CadastroGabinete extends JPanel{
    ...
    public boolean validarCliente() {
        Cliente cliente = new Cliente();
        controladorCliente cliCpf = new controladorCliente();

        if (txtNome.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "… necess·rio cadastrar o nome.", "Inv√°lido", JOptionPane.WARNING_MESSAGE);
            return false;
        }
        if (txtCpf.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "… necess·rio cadastrar o CÛdigo", "Inv√°lido", JOptionPane.WARNING_MESSAGE);
            return false;
        }
